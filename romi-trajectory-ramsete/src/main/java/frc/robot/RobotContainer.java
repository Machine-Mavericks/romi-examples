...
public class RobotContainer {
  ...
  private Command generateSlalomCommand() {
    var autoVoltageConstraint =
        new DifferentialDriveVoltageConstraint(
            new SimpleMotorFeedforward(DriveConstants.ksVolts, 
                                       DriveConstants.kvVoltSecondsPerMeter, 
    ...
    Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        // Start at the origin facing the +X direction
        FieldGeometry.SLALOM_START,
        List.of(
            FieldGeometry.SLALOM_POINT_1,
            FieldGeometry.SLALOM_POINT_2,
            FieldGeometry.SLALOM_POINT_3,
            FieldGeometry.SLALOM_POINT_4,
            FieldGeometry.SLALOM_POINT_5,
            FieldGeometry.SLALOM_POINT_6,
            FieldGeometry.SLALOM_POINT_7,
            FieldGeometry.SLALOM_POINT_8,
            FieldGeometry.SLALOM_POINT_9,
            FieldGeometry.SLALOM_POINT_10

        ),
        FieldGeometry.SLALOM_END,
        config);
 ...
 //--------------------------- end BackDiagonal right -----------------------------
  ...
  private void configureButtonBindings() {
    ...
    m_chooser.addOption("BackDiagonalRight Trajectory", generateBackDiagonalRightCommand());
    m_chooser.addOption("Slalom Trajectory", generateSlalomCommand());
